...
public class CategoryCreator {
	...
	public static void init(){
		...
		HuesoDeWikiAPI.categories.add(new BasicCategory("Footwear", (itemstack) -> itemstack.getItem() instanceof ArmorItem item && item.getType().getSlot() == EquipmentSlot.FEET));
		HuesoDeWikiAPI.categories.add(new BasicCategory("Legwear", (itemstack) -> itemstack.getItem() instanceof ArmorItem item && item.getType().getSlot() == EquipmentSlot.LEGS));
		HuesoDeWikiAPI.categories.add(new BasicCategory("Chestwear", (itemstack) -> itemstack.getItem() instanceof ArmorItem item && item.getType().getSlot() == EquipmentSlot.CHEST));
		HuesoDeWikiAPI.categories.add(new BasicCategory("Headwear", (itemstack) -> itemstack.getItem() instanceof ArmorItem item && item.getType().getSlot() == EquipmentSlot.HEAD));
