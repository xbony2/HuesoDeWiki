...
public class InfoboxCreator {
	...
	static {
		...
		parameters.add(new BasicInstanceOfParameter("saturation", (itemstack) -> Utils.floatToString(((ItemFood)itemstack.getItem()).getSaturationModifier(itemstack)), ItemFood.class));
